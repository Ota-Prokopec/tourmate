...
export const getAccountByMyId = (
	options: Omit<WatchQueryOptions<GetAccountByMyIdQueryVariables>, 'query'>
): Readable<
	ApolloQueryResult<GetAccountByMyIdQuery> & {
		query: ObservableQuery<GetAccountByMyIdQuery, GetAccountByMyIdQueryVariables>;
	}
> => {
	const q = client.watchQuery({
...
export const getAccountWithExperiences = (
	options: Omit<WatchQueryOptions<GetAccountWithExperiencesQueryVariables>, 'query'>
): Readable<
	ApolloQueryResult<GetAccountWithExperiencesQuery> & {
		query: ObservableQuery<GetAccountWithExperiencesQuery, GetAccountWithExperiencesQueryVariables>;
	}
> => {
	const q = client.watchQuery({
...
export const getAccountWithExperiencesAndMonuments = (
	options: Omit<WatchQueryOptions<GetAccountWithExperiencesAndMonumentsQueryVariables>, 'query'>
): Readable<
...
export const getAccountWithMonuments = (
	options: Omit<WatchQueryOptions<GetAccountWithMonumentsQueryVariables>, 'query'>
): Readable<
	ApolloQueryResult<GetAccountWithMonumentsQuery> & {
		query: ObservableQuery<GetAccountWithMonumentsQuery, GetAccountWithMonumentsQueryVariables>;
	}
> => {
	const q = client.watchQuery({
...
export const createExperience = (
	options: Omit<MutationOptions<any, CreateExperienceMutationVariables>, 'mutation'>
) => {
...
export const getExperience = (
	options: Omit<WatchQueryOptions<GetExperienceQueryVariables>, 'query'>
): Readable<
	ApolloQueryResult<GetExperienceQuery> & {
		query: ObservableQuery<GetExperienceQuery, GetExperienceQueryVariables>;
	}
> => {
	const q = client.watchQuery({
...
export const getListOfExperiences = (
	options: Omit<WatchQueryOptions<GetListOfExperiencesQueryVariables>, 'query'>
): Readable<
	ApolloQueryResult<GetListOfExperiencesQuery> & {
		query: ObservableQuery<GetListOfExperiencesQuery, GetListOfExperiencesQueryVariables>;
	}
> => {
	const q = client.watchQuery({
...
export const getListOfExperiencesWithCreator = (
	options: Omit<WatchQueryOptions<GetListOfExperiencesWithCreatorQueryVariables>, 'query'>
): Readable<
...
export const getListOfMonumentsWithCreator = (
	options: Omit<WatchQueryOptions<GetListOfMonumentsWithCreatorQueryVariables>, 'query'>
): Readable<

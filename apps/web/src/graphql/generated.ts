...
export type LoginViaEmailQuery = {
	__typename?: 'Query';
	logInViaEmail: { __typename?: 'EmailLogin'; session: string };
};
...
export type GetAccountByMyIdQuery = {
	__typename?: 'Query';
	getAccountByMyId: {
		__typename?: 'Account';
		_permissions: Array<string>;
...
export type GetAccountByMyIdWithExperiencesAndMonumentsQuery = {
	__typename?: 'Query';
	getAccountByMyId: {
		__typename?: 'Account';
		_permissions: Array<string>;
...
export type GetAccountWithMonumentsQuery = {
	__typename?: 'Query';
	getAccount: {
		__typename?: 'Account';
		_permissions: Array<string>;
...
export type GetListOfExperiencesQuery = {
	__typename?: 'Query';
	getListOfExperiences: Array<{
		__typename?: 'Experience';
		_createdAt: string;
		_updatedAt: string;
		_collectionId: string;
...
export type GetListOfExperiencesWithCreatorQuery = {
	__typename?: 'Query';
	getListOfExperiences: Array<{
		__typename?: 'Experience';
		_createdAt: string;
...
export type GetListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonumentsQueryVariables =
	Exact<{
		input?: InputMaybe<MonumentInput>;
...
export type GetListOfMonumentsWithCreatorQuery = {
	__typename?: 'Query';
	getListOfMonuments: Array<{
		__typename?: 'Monument';
		_createdAt: string;
...
export type GetMonumentWithCreatorAndNearestListOfExperienceQuery = {
	__typename?: 'Query';
	getMonument: {
		__typename?: 'Monument';
		_createdAt: string;
...
export const GetListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonumentsDocument = gql`
	query getListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonuments(
		$input: MonumentInput
		$getListOfExperienceInput2: ExperienceInput
	) {
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
	return {
		...
		): Promise<CreateAccountQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<CreateAccountQuery>(CreateAccountDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'createAccount',
		...
		loginViaEmail(
			variables: LoginViaEmailQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<LoginViaEmailQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<LoginViaEmailQuery>(LoginViaEmailDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'loginViaEmail',
		...
		getAccountByMyId(
			variables: GetAccountByMyIdQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetAccountByMyIdQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAccountByMyIdQuery>(GetAccountByMyIdDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getAccountByMyId',
		...
		getAccountByMyIdWithExperiencesAndMonuments(
			variables: GetAccountByMyIdWithExperiencesAndMonumentsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetAccountByMyIdWithExperiencesAndMonumentsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAccountByMyIdWithExperiencesAndMonumentsQuery>(
						GetAccountByMyIdWithExperiencesAndMonumentsDocument,
						variables,
		...
		getAccountWithExperiences(
			variables?: GetAccountWithExperiencesQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetAccountWithExperiencesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAccountWithExperiencesQuery>(
						GetAccountWithExperiencesDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getAccountWithExperiences',
		...
		getAccountWithExperiencesAndMonuments(
			variables?: GetAccountWithExperiencesAndMonumentsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetAccountWithExperiencesAndMonumentsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAccountWithExperiencesAndMonumentsQuery>(
						GetAccountWithExperiencesAndMonumentsDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getAccountWithExperiencesAndMonuments',
		...
		getAccountWithMonuments(
			variables?: GetAccountWithMonumentsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetAccountWithMonumentsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetAccountWithMonumentsQuery>(GetAccountWithMonumentsDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getAccountWithMonuments',
		...
		updateProfilePicture(
			variables: UpdateProfilePictureQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<UpdateProfilePictureQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<UpdateProfilePictureQuery>(UpdateProfilePictureDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'updateProfilePicture',
		...
		createExperience(
			variables: CreateExperienceMutationVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<CreateExperienceMutation> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<CreateExperienceMutation>(CreateExperienceDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'createExperience',
		...
		getExperience(
			...
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetExperienceQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetExperienceQuery>(GetExperienceDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getExperience',
		...
		getExperienceWithCreatorAndHisOtherExperiences(
			variables: GetExperienceWithCreatorAndHisOtherExperiencesQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetExperienceWithCreatorAndHisOtherExperiencesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetExperienceWithCreatorAndHisOtherExperiencesQuery>(
						GetExperienceWithCreatorAndHisOtherExperiencesDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getExperienceWithCreatorAndHisOtherExperiences',
		...
		getListOfExperiences(
			variables?: GetListOfExperiencesQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetListOfExperiencesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetListOfExperiencesQuery>(GetListOfExperiencesDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getListOfExperiences',
		...
		getListOfExperiencesWithCreator(
			variables?: GetListOfExperiencesWithCreatorQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetListOfExperiencesWithCreatorQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetListOfExperiencesWithCreatorQuery>(
						GetListOfExperiencesWithCreatorDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getListOfExperiencesWithCreator',
		...
		getListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonuments(
			variables?: GetListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonumentsQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonumentsQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonumentsQuery>(
						GetListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonumentsDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getListOfExperiencesWithCreatorAndListOfMonumentsWithCreatorAndHisOtherMonuments',
		...
		createMonument(
			variables: CreateMonumentMutationVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<CreateMonumentMutation> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<CreateMonumentMutation>(CreateMonumentDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'createMonument',
		...
		getListOfMonumentsWithCreator(
			variables?: GetListOfMonumentsWithCreatorQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetListOfMonumentsWithCreatorQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetListOfMonumentsWithCreatorQuery>(
						GetListOfMonumentsWithCreatorDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getListOfMonumentsWithCreator',
		...
		getListOfMonumentsWithCreatorAndNearestExperiences(
			variables?: GetListOfMonumentsWithCreatorAndNearestExperiencesQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetListOfMonumentsWithCreatorAndNearestExperiencesQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetListOfMonumentsWithCreatorAndNearestExperiencesQuery>(
						GetListOfMonumentsWithCreatorAndNearestExperiencesDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getListOfMonumentsWithCreatorAndNearestExperiences',
		...
		getMonument(
			variables: GetMonumentQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetMonumentQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetMonumentQuery>(GetMonumentDocument, variables, {
						...requestHeaders,
						...wrappedRequestHeaders
					}),
				'getMonument',
		...
		getMonumentWithCreatorAndNearestListOfExperience(
			variables: GetMonumentWithCreatorAndNearestListOfExperienceQueryVariables,
			requestHeaders?: GraphQLClientRequestHeaders
		): Promise<GetMonumentWithCreatorAndNearestListOfExperienceQuery> {
			return withWrapper(
				(wrappedRequestHeaders) =>
					client.request<GetMonumentWithCreatorAndNearestListOfExperienceQuery>(
						GetMonumentWithCreatorAndNearestListOfExperienceDocument,
						variables,
						{ ...requestHeaders, ...wrappedRequestHeaders }
					),
				'getMonumentWithCreatorAndNearestListOfExperience',

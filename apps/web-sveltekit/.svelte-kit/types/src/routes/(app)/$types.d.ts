...
type LayoutRouteId = RouteId | "/(app)/(main)" | "/(app)/account/[myId]" | "/(app)/account/[myId]/edit" | "/(app)/addMonument" | "/(app)/addMonument/detail/[lat]-[lng]" | "/(app)/experience/[experienceId]" | "/(app)/monument/[monumentId]" | "/(app)/search"
type LayoutParams = RouteParams & { myId?: string,lat?: string,lng?: string,experienceId?: string,monumentId?: string }

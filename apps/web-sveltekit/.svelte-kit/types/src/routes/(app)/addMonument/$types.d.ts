...
type LayoutRouteId = RouteId | "/(app)/addMonument" | "/(app)/addMonument/detail/[lat]-[lng]"
type LayoutParams = RouteParams & { lat?: string,lng?: string }

...
var Notifications = (firebase, vapidKey) => {
    const notifications = messaging__namespace.getMessaging(firebase);
    const generateToken = (serviceWorkerRegistration) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return yield messaging__namespace.getToken(notifications, {
            vapidKey: vapidKey,
            serviceWorkerRegistration: serviceWorkerRegistration,
        });
    });
    const watchNotifications = (callback) => {
        messaging__namespace.onMessage(notifications, callback);
    };

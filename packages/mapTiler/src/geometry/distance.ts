...
export function lineDistance(
	line: GeoJSON.Feature<GeoJSON.LineString> | GeoJSON.LineString | GeoJSON.Position[],
) {
...
export function pointDistance(from: GeoJSON.Position, to: GeoJSON.Position): number {

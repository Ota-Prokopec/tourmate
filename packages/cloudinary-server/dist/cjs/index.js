...
class Cloudinary {
    ...
    uploadBase64(base64) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield cloudinary.v2.uploader.upload(base64, Object.assign(Object.assign({}, this.options), { folder: this.folder })));
        });
    }
    deleteFiles(...files) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield cloudinary.v2.api.delete_resources(files.map((file) => `${this.folder}/${file}`));
        });
    }
...
const options = cloudinary.v2.config({

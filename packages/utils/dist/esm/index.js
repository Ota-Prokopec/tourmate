...
import { topicZod, transportZod } from '@app/ts-types';
...
const getTimeFromAToB = (location1, location2, speed) => {
    const distance = geolocationUtils.distanceTo({ lat: location1[0], lng: location1[1] }, { lat: location2[0], lng: location2[1] });
 ...
 * @returns meters
 */
const distanceTo = (location1, location2) => geolocationUtils.distanceTo({ lat: location1[0], lng: location1[1] }, { lat: location2[0], lng: location2[1] });
...
export { arrayBufferIntoBase64, base64ToBlob, base64ToFile, blobToBase64, changeURLwithoutReloading, clipboard, colors, countSameItemsInArray, degreeToMeters, device, distanceTo, elementIdGenerator, executeFunctionBeforeAndAfterClassMethod, fileToBase64, get, getLocationUrlOfGoogleMaps, getParsed, getPrettyNumber, getThemeInternalMode, getTimeFromAToB, getUniqueListBy, getUsersLocation, getUsersLocationDataByIP, isBase64, isFile, isLocation, isTopic, isTransport, isTrivial$1 as isTrivial, isURL, metersOfOneDegree, metersToDegree, normalizeMeters, normalizeTime, notify, parseApolloError, post, proxify, removeItemsFromArray, removeKeysFromObject, roundNumber, uniqueArrayItems, urlToString, watchUsersLocation };
